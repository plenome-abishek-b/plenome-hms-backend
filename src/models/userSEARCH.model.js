...
userSearch.getstaffdetails = (result)=>{
    ...
    userSearch.getstaffdetailsById = (id,result)=>{
    ...
    userSearch.getstaffdetailsByName = (name,result)=>{
    ...
    // userSearch.getstaffdetailsByRoles = (role,result)=>{
    //     dbconn.query('select * from staff where role=?',role,(err,res)=>{
    //         if(err){
    //             console.log('error occured while getting by role',err);
    //             result(null,err);
    //         }else{
    //             console.log('staff fetched by role');
    //             result(null,res);
    //         }
    //     })
    // }

    userSearch.getstaffdetailsBygender = (gender,result)=>{
        dbconn.query('select * from staff where gender=?',gender,(err,res)=>{
            if(err){
                console.log('error occured while getting by gender',err);
                result(null,err);
            }else{
                console.log('staff fetched by gender');
                result(null,res);
            }
        })
    }
